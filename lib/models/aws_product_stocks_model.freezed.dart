...
mixin _$AwsProductStocks {
  ...
  DisplayNameModel? get categId => throw _privateConstructorUsedError;
...
abstract class $AwsProductStocksCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'categ_id') DisplayNameModel? categId,
...
class _$AwsProductStocksCopyWithImpl<$Res, $Val extends AwsProductStocks>
  ...
  @pragma('vm:prefer-inline')
  $DisplayNameModelCopyWith<$Res>? get categId {
    if (_value.categId == null) {
      return null;
    }

    return $DisplayNameModelCopyWith<$Res>(_value.categId!, (value) {
      return _then(_value.copyWith(categId: value) as $Val);
    });
  }
}
...
class _$AwsProductStocksImpl implements _AwsProductStocks {
  const _$AwsProductStocksImpl(
      ...
      @JsonKey(name: 'categ_id') required this.categId,
  ...
  @override
  @JsonKey(name: 'categ_id')
  final DisplayNameModel? categId;
  @override
  @JsonKey(name: 'avg_cost')
  ...
  @override
  String toString() {
    return 'AwsProductStocks(id: $id, displayName: $displayName, categId: $categId, avgCost: $avgCost, totalValue: $totalValue, qtyAvailable: $qtyAvailable, freeQty: $freeQty, incomingQty: $incomingQty, outgoingQty: $outgoingQty, virtualAvailable: $virtualAvailable, warehouseId: $warehouseId)';
  }
...
abstract class _AwsProductStocks implements AwsProductStocks {
  const factory _AwsProductStocks(
      ...
      @JsonKey(name: 'categ_id') required final DisplayNameModel? categId,
      ...
      required final int? warehouseId}) = _$AwsProductStocksImpl;
...
class _$CurrentWarehouseImpl implements _CurrentWarehouse {
  ...
  @override
  String toString() {
    return 'CurrentWarehouse(id: $id, name: $name, code: $code)';
  }
